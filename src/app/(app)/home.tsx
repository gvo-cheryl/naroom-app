...
export default function HomeScreen() {
  ...
  const displayName =
    state.status === "active" ? state.account.displayName : "";
    ...
    useCallback(() => {
      ...
      (async () => {
        try {
          ...
          setLatestEntry(
            entries.find((entry) =>
              VISIBLE_ENTRY_TYPES.includes(entry.entryType),
            ) ?? null,
          );
          setTodayQuote(quote);
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {todayCheckIn ? (
            ...
            >
              ...
              {todayCheckIn.emotionIntensity !== null && (
                <LevelBar
                  ...
                  levelLabel={
                    INTENSITY_LABELS[
                      levelLabelIndex(
                        todayCheckIn.emotionIntensity,
                        INTENSITY_LABELS.length,
                      )
                    ]
                  }
                  color={theme.text}
              ...
              {todayCheckIn.currentNeed && (
                <NeedSummary need={todayCheckIn.currentNeed} />
              )}
            ...
            {latestEntry ? (
              <Pressable
                ...
                onPress={() =>
                  router.push({
                    pathname: "/day/[date]",
                    params: { date: latestEntry.recordDate },
                  })
                }
              >
                <ThemedText type="small" themeColor="textTertiary">
                  최근 기록 · {entryTypeLabel(latestEntry.entryType)} ·{" "}
